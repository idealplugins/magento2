...
{
    const METHOD_CODE = 'paysafecard';
    const METHOD_TYPE = 'WAL';
    ...
    public function setupPayment($bankId = false)
    {
        ...
        $testMode = (bool) $this->_scopeConfig->getValue('payment/paysafecard/testmode');
        
        $digiCore = new TargetPayCore(
            $this->tpMethod,
            $this->_scopeConfig->getValue('payment/paysafecard/rtlo'),
            $language,
            $testMode
        );
